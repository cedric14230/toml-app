  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Formulaire */}
        <form id="create-wl-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 pt-5 pb-3 space-y-5">
          {error && (
          ...
          <div>
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-3 gap-2" role="radiogroup" aria-label="Visibilité de la wishlist">
                ...
                return (
                  <label
                    ...
                    className={`
                      ...
                      sm:flex-col sm:items-center sm:gap-1.5 sm:text-center
                  ...
                  >
                    ...
                    <span className="flex-1 sm:flex-none sm:text-center">
                      <span className="block text-xs font-semibold leading-none">{opt.label}</span>
                      <span className={`block text-[10px] leading-none mt-0.5 ${isSelected ? 'text-gray-300' : 'text-gray-400'}`}>
                        {opt.description}
                      </span>
                    </span>
                  </label>
        ...
        {/* Actions — footer fixe hors du scroll, toujours visible */}
        <div className="flex-shrink-0 flex gap-3 px-6 pt-3 pb-5 border-t border-gray-100">
          <button
            type="button"
            onClick={onClose}
