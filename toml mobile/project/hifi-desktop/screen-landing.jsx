// Toml Hi-fi Desktop — Landing
// Hero split : copy à gauche, stack de cards wishlist tiltées à droite

const HDLandingCardFloat = ({ tilt, top, left, right, bottom, width, owner, ownerTone, listName, brand, title, price, stars, tone, reserved, by }) => (
...
const HDLanding = () => (
  <HDShell url="toml.app" active="" authed={false}>
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Une wishlist propre, jolie, partageable. Tu y mets ce qui te fait envie depuis n'importe quel site,
          tes proches voient ce qui te ferait vraiment plaisir.
        </p>
        <div style={{ display: 'flex', gap: 12, marginBottom: 36 }}>
          <button className="btn btn-primary btn-stamp btn-lg">Créer ma wishlist</button>
          <button className="btn btn-outline btn-lg">Découvrir une liste</button>
        </div>
