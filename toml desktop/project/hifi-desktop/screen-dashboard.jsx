// Toml Hi-fi Desktop — Dashboard
// Header + chips filters + grid 3-col de cards wishlist

const HDDashboardCard = ({ title, count, vis, icon, latest, tone, note }) => (
  <div className="card" style={{ display: 'flex', flexDirection: 'column' }}>
    ...
    <div style={{ padding: 18, display: 'flex', flexDirection: 'column', gap: 8, flex: 1 }}>
      ...
      {note && <div className="voice" style={{ fontSize: 13 }}>« {note} »</div>}
...
const HDDashboard = () => {
  ...
  return (
    <HDShell url="toml.app/dashboard" active="lists">
      <div style={{ padding: '32px 40px 60px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="btn btn-primary btn-stamp" style={{ marginLeft: 8 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, marginBottom: 24 }}>
          {lists.map((l, i) => <HDDashboardCard key={i} {...l} />)}
...
window.HDDashboard = HDDashboard;
